# Generated by Django 2.0.3 on 2018-04-04 09:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='image/default.jpg', upload_to='image/%Y/%m', verbose_name='标题图片')),
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jakejieblog.Category', verbose_name='文章类型'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
